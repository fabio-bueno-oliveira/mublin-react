...
import { Grid, Header, Segment, Form, Image, Icon, Loader, Label, Button } from 'semantic-ui-react';
    ...
    return (
        <>
            ...
            <Grid as='main' centered columns={1} className="container mb-5 pb-4 px-1 px-md-3">
                ...
                <Grid.Row>
                    <Grid.Column computer={10} mobile={16}>
                        <Header as='h3' className='mb-1'>Meus projetos ({userInfo.requesting ? 'Carregando...' : userProjects.length})</Header>
